...
int main() {
	...
	cout << "После добавления сред. арифмет. : " << endl << first_queue << endl;
	Pair p_one, p_two;
	cout << "Введите пары для диапазона удаления: " << endl;
	...
	cout << "Максимальная пара: " << max_p << endl;
	cout << "Минимальная пара: " << min_p << endl;
	
	sum = max_p + min_p;
	cout << "Сумма максимального и минимального: " << sum << endl;
